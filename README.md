...
| 35  | Web: PUT Method | [Web: PUT Method](https://www.meetgor.com/golang-web-put-method/) | [web/put-method](https://github.com/Mr-Destructive/100-days-of-golang/tree/main/web/methods/put) | [net/http](https://pkg.go.dev/net/http), [encoding/json](https://pkg.go.dev/encoding/json)  |
