...
| 22  | File Read | [File Read in Golang](https://www.meetgor.com/golang-file-read/) | [paths](https://github.com/mr-destructive/100-days-of-golang/tree/main/scripts/files/read) | [os](https://pkg.go.dev/os#ReadFile), [bufio](https://pkg.go.dev/bufio) |
